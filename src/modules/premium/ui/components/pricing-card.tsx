...
const pricingCardVariants = cva("rounded-lg p-4 py-6 w-full", {
  variants: {
    variant: {
      ...
      highlighted: "bg-linear-to-br from-[#09193C] to-[#050B1B] text-white",
    },
  },
  defaultVariants: {
    variant: "default",
...
const pricingCardBadeVariants = cva("text-black text-xs font-normal p-1", {
  variants: {
    variant: {
      ...
      <div className="flex items-end gap-x-4 justify-between">
        <div className="flex flex-col gap-y-2">
          <div className="flex items-center gap-x-2">
            ...
            {badge ? (
              <Badge className={cn(pricingCardBadeVariants({ variant }))}>
                {badge}
              </Badge>
            ) : null}
          </div>
